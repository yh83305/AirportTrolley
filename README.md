...
**AirportTrolley** 是面向机场、车站等大尺度动态公共环境打造的全栈自主行李手推车收集与运输机器人系统。项目围绕散落手推车的自主回收任务，构建了从多模态感知与高精度定位、全局任务规划与动态避障，到视觉引导对接、双机械臂抓取/推运及多车协同运输的完整作业闭环，旨在以机器人集群替代高强度、重复性的人工手推车调度工作。

系统采用模块化软硬件架构，融合 LiDAR–IMU SLAM、视觉/UWB/VRPN 定位、Hybrid A* 全局规划、MPC/CBF/CVaR 局部决策、扰动观测与自适应控制、双臂柔顺力控以及 CAN 总线实时驱动。仓库同时覆盖算法仿真、单机实物实验和多机器人系统集成，可作为自主移动操作、非完整约束机器人协同运输及复杂公共空间服务机器人研究的一体化实验平台。
